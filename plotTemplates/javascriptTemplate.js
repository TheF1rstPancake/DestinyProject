...
var data = $.getJSON('datafiles/{{ destinyGraph.jsonFileName }}', function(test_data){
    var plotDiv = "#{{ destinyGraph.divTitle }}";
    ...
    nv.addGraph({
        generate: function() {   
            ...
            var chart = nv.models.multiBarChart()
                .width(width)
                .height(height)
                .stacked({{ destinyGraph.stacked }})
                .reduceXTicks({{ destinyGraph.stacked }})   //If 'false', every single x-axis tick label will be rendered.
                ;
