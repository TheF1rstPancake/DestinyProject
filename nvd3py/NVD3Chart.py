...
pl = FileSystemLoader('nvd3py/templates')
...
class NVD3Chart(object):
    ...
    def __init__(self, **kwargs):
        ...
        self.title = kwargs.get("title","Hello World!")
        self.subtitle = kwargs.get("subtitle", "Hello World!")
        self.plotText = kwargs.get("plotText", "")
        ...
        self.javascriptFileLocation = self.jsFile
        self.fullJS = os.path.join(kwargs.get("html_path", '.'), self.jsFile)
        self.scriptTag = "<script src = {0}></script>".format(self.jsFile)
        ...
        self.xOrdinalValues = kwargs.get("xOrdinalValues", None)
    ...
    def create_x_axis(self, name, label=None, tickValues = None, format=None, date=False, custom_format=False, extras={}):
        """Create X-axis"""
        axis = {}
        if tickValues:
    ...
    def create_y_axis(self, name, label=None, format=None, custom_format=False, extras={}):
        """
        Create Y-axis
        """
        axis = {}
